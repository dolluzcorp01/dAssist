...
function TicketDashboard() {
    ...
    const exportToPDF = (tickets) => {
        ...
        autoTable(doc, {
            ...
            styles: {
                fontSize: 7,
                cellWidth: "wrap",       // ✅ shrink if too wide
                overflow: "linebreak",   // ✅ wrap text into multiple lines
            },
            columnStyles: {
                2: { cellWidth: 40 },   // Email column
                7: { cellWidth: 40 },   // Subject column
                10: { cellWidth: 35 },  // Date column
            },
