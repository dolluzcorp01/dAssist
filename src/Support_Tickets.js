...
import { FaPaperclip, FaInfoCircle, FaFilePdf, FaFileExcel, FaDownload, FaSpinner, FaCamera } from "react-icons/fa";
...
function TicketDashboard() {
    ...
    const exportToPDF = (tickets) => {
        ...
        autoTable(doc, {
            ...
            body: tickets.map(ticket => [
                ...
                ticket.subject,
                ticket.attachment_file ? "Yes" : "No",
                ticket.ticket_status,
                new Date(ticket.created_time).toLocaleString(),
            ]),
            startY: 70, // ✅ Push table down more
            margin: { top: 60 },
            theme: "grid",
            styles: { fontSize: 7, cellWidth: "wrap", overflow: "linebreak" },
            columnStyles: { 2: { cellWidth: 40 }, 7: { cellWidth: 40 }, 10: { cellWidth: 35 } },
            ...
            didDrawPage: function () {
                ...
                doc.setFontSize(9);
                doc.text("Generated by dAssist", pageWidth / 2, 54, { align: "center" });
            },
        });
    ...
    const exportToExcel = async (tickets) => {
        ...
        worksheet.addImage(imageId, {
            ...
            ext: { width: 200, height: 100 }, // ✅ Increased logo size
        });

        // ✅ Add some blank rows under the logo
        worksheet.addRow([]);
        worksheet.addRow([]);
        worksheet.addRow([]);
        ...
        worksheet.getCell("A4").value = "Tickets Report";
        worksheet.getCell("A4").font = { size: 14, bold: true };
        worksheet.getCell("A4").alignment = { horizontal: "center" };

        worksheet.mergeCells("A5:D5");
        worksheet.getCell("A5").value = "Generated by dAssist";
